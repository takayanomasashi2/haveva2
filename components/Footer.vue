          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="footer-widget footer-widget__about">
                ...
                <p>Web3.0専門メディアShurikenFly代表兼ブロックチェーンエンジニア。<br>北海道旭川市生まれ、HIPHOP/R&B育ち。<br>音楽と旅が好きな人はだいたい友達。<br>ビジネス得意領域は、IT・英語・EC物流<br>お仕事のご依頼＆ご相談は、下記メールアドレスより、お気軽にお問い合わせくださいませ。</p>
    ...
    <div class="side-menu__block">
      ...
      <div class="side-menu__block-inner ">
        ...
        <div class="side-menu__content">
          <p> </p>
          <p><a href="mailto:soundslikemassage@gmail.com">soundslikemassage@gmail.com</a> 
          <br> 
